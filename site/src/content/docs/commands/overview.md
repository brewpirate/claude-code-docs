...
| 10 | [Removed / Deprecated Commands](/claude-code-docs/cli/overview/) | Tombstoned commands like `/vim` (→ v2.1.92) and `/pr-comments` (→ v2.1.91) with replacement guidance. | 2 commands |
