...
### Hook input/output
Each hook callback receives `(input, toolUseID, context)` and returns an output object controlling permission decision, input modification, or additional context injection. See [Hooks/README.md](../Hooks/README.md) for full payload schemas.
