...
**Coordinator mode** (see [Coordinator/README.md](../Coordinator/README.md)):
...
- [Agents/README.md](./README.md) — subagent overview and definition methods
- [Coordinator/README.md](../Coordinator/README.md) — full multi-agent orchestration
- [Skills/FRONTMATTER.md](../Skills/FRONTMATTER.md) — all agent frontmatter fields
- [GettingStarted/feature-gates-guide.md](../GettingStarted/feature-gates-guide.md) — scratchpad and agent team feature gates

---

[← Back to Agents/README.md](./README.md)
