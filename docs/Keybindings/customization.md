...
Actions are namespaced by context or feature. Use the action name from the **Quick Reference** in [README.md](./README.md) or specific sections.
...
**Note**: These may not exist as actions in Claude Code. Check available actions first (see [how-keybindings-work.md](./how-keybindings-work.md#action-identifiers)).
...
1. **Check shipped defaults**: Read [global-bindings.md](./global-bindings.md), [chat-bindings.md](./chat-bindings.md), etc.
...
2. **Check reserved/intercepted keys**: [Platform Quirks](./platform-quirks.md) lists OS/terminal interceptors.
...
2. **Avoid reserved keys**: Check [Platform Quirks](./platform-quirks.md) before binding.
