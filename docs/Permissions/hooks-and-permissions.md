...
[PreToolUse hooks](/en/hooks-guide) fire *before* permission rule evaluation. They can influence the decision but do not bypass the rule system:
...
See [Hooks documentation](/en/hooks-guide) for implementation details and examples.
