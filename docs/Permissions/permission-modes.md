...
- **Related:** `--permission-mode` CLI flag; `permissions.defaultMode` setting. See [Settings/permissions-security.md](../Settings/permissions-security.md).
...
- **Related:** `permissions.additionalDirectories` for expanding writable scope. See [Settings/permissions-security.md](../Settings/permissions-security.md).
...
- **Related:** `autoMode` object (environment, allow, soft_deny); `skipAutoPermissionPrompt`; `disableAutoMode`; `useAutoModeDuringPlan`. See [Settings/permissions-security.md](../Settings/permissions-security.md).
