...
Permission rules are declared and managed via these settings keys (full documentation in [Settings/permissions-security.md](../Settings/permissions-security.md)):
...
See [Settings/permissions-security.md](../Settings/permissions-security.md) for JSON examples and storage details.
